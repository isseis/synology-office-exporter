...
class TestSynologyOfficeExporter(unittest.TestCase):
    @patch('synology_office_exporter.SynologyOfficeExporter.save_bytesio_to_file')
    ...
    @patch('synology_office_exporter.SynologyOfficeExporter._process_item')
    ...
    @patch('synology_office_exporter.SynologyOfficeExporter._process_directory')
    ...
    @patch('synology_office_exporter.SynologyOfficeExporter._process_document')
    @patch('synology_office_exporter.SynologyOfficeExporter._process_directory')
    ...
    @patch('synology_office_exporter.SynologyOfficeExporter._process_directory')
    @patch('synology_office_exporter.SynologyOfficeExporter._save_download_history')
    @patch('synology_office_exporter.SynologyOfficeExporter._load_download_history')
